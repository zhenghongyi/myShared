...
let MainTextFont = "MainTextFont"
let SubTextColor = "SubTextColor"
let SubTextFont = "SubTextFont"
let AlertTextColor = "AlertTextColor"
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let navi:UINavigationController = UINavigationController(rootViewController: MainController())

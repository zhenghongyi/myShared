...
{
    NSData* modulusData = [self bytesFromHexString:modulus]; //[NSData dataWithBase64EncodedString: modulus];
    NSData* exponentData = [self bytesFromHexString:exponent]; //[NSData dataWithBase64EncodedString: exponent];

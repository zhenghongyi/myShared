...
+ (NSString *)encryptString:(NSString *)str mod:(NSString *)mod exp:(NSString *)exp {
    SecKeyRef keyRef = [RSAPubKey stringToRSAPubKey:mod andExponent:exp];
    NSData *data = [RSA encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] withKeyRef:keyRef isSign:NO];
    NSString *ret = base64_encode_data(data);
    return ret;
}
